                ...
                <div class="col-xs-12">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="mainmenu">
                        ...
                        <ul class="nav navbar-nav primary-menu">
                            ...
                            <li class="active"><a href="projects.php#projects">Projects</a></li>
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-10 col-md-8"><br /><br /><br /><br />
                        <div class="header-text">
                            <h2 class="header-title wow fadeInUp upper" style="font-size:30px">Strategic Communications &amp; inovative management for an unpredictable<em style="color:#ff7605;"></em> world<span class="dot"></span></h2>
                ...
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    ...
                    <div class="single-testimonial text-center">
                            <div class="testimonial-text">
                                <em style="color:#0d0d0d;"> Consultancy Services for development and implementation of communications strategy for national dialogue and reform process government of Lesotho. 
(Dec.2018-
June,2019)
</em>
                            </div>
                            <h5 style="color:#0d0d0d;">Government of Lesotho
 </h5>
                        ...
                        <div class="single-testimonial text-center">
                            <div class="testimonial-text">
                                <em style="color:#0d0d0d;">Consultancy Services to develop and implement communication strategy for the
Ministry of Water and Environment(MWE), Uganda	(Oct.15-
April 16)

</em>
                            </div>
                            <h5 style="color:#0d0d0d;">Ministry of
Water and
Environme
nt(MWE)
</h5>
    ...
    <section class="section-padding gray-bg" id="portfolio-area">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 ">
                    <div class="page-title text-center">
                        <h2 style="font-size:25px" class="title"> Project Portfolio</h2>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <ul class="filter-controls text-center">
                        ...
                        <li class="active filter" data-filter=".graphics">Strategic Communics</li>
                ...
                <div class="col-xs-6 col-sm-4 col-md-3 mix coding photography">
                    <div class="filter-box">
                        ...
                        <div class="filter-hover">
                            ...
                            <a href="images/flag.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
            </div>
