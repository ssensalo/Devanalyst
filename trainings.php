                        ...
                        <ul class="nav navbar-nav primary-menu">
                            ...
                            <li class="dropdown"><a>Services</a>
                                <ul class="dropdown-content">
                                    ...
                                    <li class="active"><a href="trainings.php#service-area" style="text-transform: none;">Training</a></li>
            ...
            <div class="row" class="col-md-2 col-md-offset-5">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/Stakeholder.jpg" alt="" height="12">
                            
                        </div>
                        <div class="box-text ">
                            <h4>Digital Communication</h4>
                            <p style="color:#0d0d0d;">This lesson will introduce participants to the Internet. It will provide the basics of how the Internet works and an overview of Internet hardware and software components. Top-level, country top-level, generic and sub domain names used for addressing resources on the internet will be explained. The lesson will end with an overview of legislative considerations for cyber space activities.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        ...
                        <div class="box-text">
                            <h4>Political Reporting</h4>
                            <p style="color:#0d0d0d;">Emphasis is placed on deadline writing, analyzing of political, and public policy news. The training also encourages participants’ to explore the use of social media to cover and explain reform campaigns and policy. Use of materials and messages from Reforms Communications Strategy shall be emphasized to add depth to spot news coverage.
							Political journalists should serve as watchdogs to assure honest governance and campaigns and seek to focus their coverage on issues of importance to society and not just daily “spin.”</p><br/>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
