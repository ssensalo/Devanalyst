            ...
            <div class="row" class="col-md-2 col-md-offset-5">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/host.png" class="img-rounded" alt="" height="600px">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/domain.jpg" class="img-rounded" alt=""  height="600px">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/web design.jpg" class="img-rounded" alt="">
			 ...
			 <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/digital.jpg" class="img-rounded" alt="" height="600px">
...
Digital marketing methods such as search engine optimization (SEO), search engine marketing (SEM), content marketing, influencer marketing, content automation, campaign marketing, data-driven marketing, e-commerce marketing, social media marketing, social media optimization, e-mail direct marketing, Display advertising, e–books, and optical disks and games are becoming more common in our advancing technology.
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/big data.jpg" class="img-rounded" alt=""  height="600px">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box">
                        <div class="box-image">
                            <img src="images/email.jpg" class="img-rounded" alt=""><br/><br/>
